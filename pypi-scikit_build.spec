...
%prep
%setup -q -n scikit-build-0.12.0
cd %{_builddir}/scikit-build-0.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642619871
...
cp %{_builddir}/scikit-build-0.12.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-scikit_build/48d9b98c9f043b5a42399020beaac0aa6afbc4b3
