...
Source0  : https://files.pythonhosted.org/packages/f0/dc/4dc5ef1b52d8ab46efd1bc047e1fc0c8864d450f5c0274dd3142404f2d9c/scikit-build-0.16.4.tar.gz
...
%prep
%setup -q -n scikit-build-0.16.4
cd %{_builddir}/scikit-build-0.16.4
pushd ..
cp -a scikit-build-0.16.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671476978
