...
Version  : 0.16.1
Release  : 17
URL      : https://files.pythonhosted.org/packages/ce/9b/cd7e5e681432f73bb2a666a757618b54742a5207c1ac94622987769e5834/scikit-build-0.16.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ce/9b/cd7e5e681432f73bb2a666a757618b54742a5207c1ac94622987769e5834/scikit-build-0.16.1.tar.gz
...
%prep
%setup -q -n scikit-build-0.16.1
cd %{_builddir}/scikit-build-0.16.1
pushd ..
cp -a scikit-build-0.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667228106
