...
Source0  : https://files.pythonhosted.org/packages/ca/6a/6b6003a757a97c4a992b611b122fa7b5efeb0b498f09123829a30e79e8c1/scikit-build-0.16.3.tar.gz
...
%prep
%setup -q -n scikit-build-0.16.3
cd %{_builddir}/scikit-build-0.16.3
pushd ..
cp -a scikit-build-0.16.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669935610
