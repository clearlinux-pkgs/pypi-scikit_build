...
Version  : 0.16.6
Release  : 23
URL      : https://files.pythonhosted.org/packages/00/91/2c7cd1a6b567e8e40c1677c61aba39e5f14ccf06ac78ae4fa6acb84ae140/scikit-build-0.16.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/00/91/2c7cd1a6b567e8e40c1677c61aba39e5f14ccf06ac78ae4fa6acb84ae140/scikit-build-0.16.6.tar.gz
...
%prep
%setup -q -n scikit-build-0.16.6
cd %{_builddir}/scikit-build-0.16.6
pushd ..
cp -a scikit-build-0.16.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674259765
