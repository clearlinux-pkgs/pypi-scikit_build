...
Version  : 0.16.2
Release  : 18
URL      : https://files.pythonhosted.org/packages/a5/af/2e9a2b6a4dcfeb9135aa49c9e06504c2b44ad655cdb54fff452d8c15311a/scikit-build-0.16.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a5/af/2e9a2b6a4dcfeb9135aa49c9e06504c2b44ad655cdb54fff452d8c15311a/scikit-build-0.16.2.tar.gz
...
%prep
%setup -q -n scikit-build-0.16.2
cd %{_builddir}/scikit-build-0.16.2
pushd ..
cp -a scikit-build-0.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667844779
